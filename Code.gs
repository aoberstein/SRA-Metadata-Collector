...
function getMetadataRequest(response) {
  ...
  //var response = {accessions:['GSE48812'],parameters:{save_pref:false}}; // Example GSE not found with SRA search.
  //var response = {accessions:['PRJDB7477'],parameters:{save_pref:false}}; // Example Bioproject.
  //var response = {accessions:['SRP158392'],parameters:{save_pref:false}}; // Example SRP.
  //var response = {accessions:['PRJNA523380'],parameters:{save_pref:false}}; // Extremely large.
  //var response = {accessions:['HT-29'],parameters:{save_pref:false}}; // Example of SRA search.
